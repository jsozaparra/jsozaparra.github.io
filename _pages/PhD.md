...
<section id="card-carousel-4" class="splide" aria-label="Beautiful Images">
  <div class="splide__track">
		<ul class="splide__list">
			...
			<li class="splide__slide" style="width: 180px">
                <div class="splide__slide__container">
				    <img src="/assets/img/phd/4-Phd-8-2.jpg" alt="" data-zoomable="">
                </div>
...
<p align="center">
<i>I want to thank Sebastián and Juan Carlos from the bottom of my heart for raising me up both figuratively and literally (see below). Without their continuous support and commitment, I wouldn't have come this far.</i>
</p>
