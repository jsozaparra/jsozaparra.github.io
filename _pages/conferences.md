...
L.geoJSON(locations, {
  onEachFeature: function (feature, layer) {
    layer.bindPopup('<h2 style="color:black;"><a href='+feature.properties.Link+'>'+feature.properties.Conference+'</a></h2><p style="color:black;">name: '+feature.properties.Location+'</p>');
  }
}).addTo(markers);
