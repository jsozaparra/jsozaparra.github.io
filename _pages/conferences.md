...
<script>
    ...
    const marker = L.marker(new L.LatLng(37.8708393, -122.2728638), { title: "title" }).addTo(markers);

    const marker = L.marker(new L.LatLng(37.7792808, -122.4192362), { title: "title" }).addTo(markers);
